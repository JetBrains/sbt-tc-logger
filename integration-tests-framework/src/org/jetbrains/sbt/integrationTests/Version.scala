...
import org.jetbrains.sbt.integrationTests.Version.VersionStatus.VersionStatus

import scala.math.Ordering.Implicits.*

/**
 * @note copied from sbt-structure `org.jetbrains.sbt.integrationTests.utils.Version`.
 *       Adaptations: package changed for sbt-teamcity-logger tests; no behavioral changes intended.
 */
