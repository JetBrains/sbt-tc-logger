...
import _root_.org.jetbrains.teamcity.plugins.sbt.logger.TCCompilerReporter.*
import _root_.org.jetbrains.teamcity.plugins.sbt.logger.apiAdapter.{ReporterAdapter, toFilePosition}
